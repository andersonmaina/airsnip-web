  ...
  return (
    <footer className="footer" style={{ borderTop: '1px solid var(--border-blue)', padding: '4rem 0 2rem' }}>
      <div className="container">
        <div className="footer-top" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '4rem' }}>
          ...
          <div className="footer-right" style={{ fontSize: '0.875rem', color: 'var(--text-primary)', fontWeight: 500 }}>
            Made for developers.
          </div>
        </div>
